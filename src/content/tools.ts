...
export const tools: Tool[] = [
  ...
  { slug: 'convert', name: '画像の形式を変換（JPG・PNG・WebP）', ready: true,
    lead: 'JPG・PNG・WebPを相互に変換します。',
    body: 'WebPにすると、同じ見た目のままファイルが小さくなります。透過の扱いも選べます。' },
  { slug: 'exif', name: '画像のEXIF・位置情報を削除', ready: true,
    lead: '撮影日時・カメラ情報・位置情報だけを取り除きます。',
    body: '画素には触れず情報の区画だけを外すので、画質は1ドットも変わりません。ICCプロファイルは残します。' },
  { slug: 'favicon', name: 'ファビコンを作る', ready: true,
    lead: '1枚の画像から、必要なサイズをまとめて書き出します。',
    body: '16 / 32 / 48 / 180 / 192 / 512 px を一度に。ZIPで受け取れます。' },
  { slug: 'appicon', name: 'アプリアイコンのサイズを一括生成', ready: true,
    lead: 'App Store と Google Play に必要なサイズをまとめて書き出します。',
